 ...
 <?php
   include '../config/koneksi.php';
 			...
 			if (!isset($_POST['cari']) && empty($_POST['pencarian'])) {
 	 			$sql=mysqli_query($test, "SELECT * FROM tb_rekam_medis ORDER BY id desc ");
   ...
   <?php
 					...
 					$sql4	=	mysqli_query($test, "SELECT * FROM tb_pasien WHERE nik_pasien='$_POST[pencarian]'");
 					$bc4	=	mysqli_fetch_array($sql4);

 	$sql=mysqli_query($test, "SELECT * FROM tb_rekam_medis WHERE id_pasien='$bc4[id_pasien]' ORDER BY id desc ");
 	while($bc=mysqli_fetch_array($sql)){
...
<?php
 include '../config/koneksi.php';
     $no=0;
       $sql=mysqli_query($test, "SELECT * FROM tb_pasien WHERE stts='1'  ORDER BY id_pasien desc ");
       while($bc=mysqli_fetch_array($sql)){
  $no++;
 ?>
 <tbody>
...
include '../config/koneksi.php';
    $no=0;
      $sql=mysqli_query($test, "SELECT * FROM tb_user");
      while($bc=mysqli_fetch_array($sql)){
