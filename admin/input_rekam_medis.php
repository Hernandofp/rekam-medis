        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                mysqli_select_db($test,"rekam_medis");				
				 $result = mysqli_query($test, "select * from tb_pasien"); 	 
			...
			echo '<option value="">Pilih Nama Pasien</option>';  
				while ($row = mysqli_fetch_array($result)) {  
				 ...
				 $test = mysqli_connect("localhost", "root", "");
                 mysqli_select_db($test,"rekam_medis");      
				$result = mysqli_query($test, "select * from tb_dokter"); 	 
				$jsArray = "var prdName = new Array();\n"; 
...
<?php
 ...
 if(isset($_POST['kirim'])){
	...
	$cek = mysqli_num_rows(mysqli_query($test, $sql));
