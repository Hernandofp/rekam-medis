				...
				<div class="col-lg-6">
                  ...
                  <div class="form-group">
                          ...
                          <input class="form-control" placeholder="Enter text" name="nik_pasien" required>
                  </div>
                   <div class="form-group">
...
include '../config/koneksi.php';
 ...
 if(isset($_POST['kirim'])){
	...
	$sql1 = "insert into tb_pasien values ('', '$nik_pasien', '$nama_pasien', '$umur',  '$jk', '$tgl_lahir', '$alamat_pasien', '$tgl_daftar','1')";
