             ...
             <div class="form-group">
                    ...
                    <select name="pasien" class="form-control" required>
                      ...
                      <?php
                              ...
                              $sql1 = mysqli_query($test, "SELECT * FROM tb_pasien WHERE stts='1'");
                              while($bc1=mysqli_fetch_array($sql1))
                              {
              ...
              <div class="form-group">
                     ...
                     <select name="dokter" class="form-control" required>
                       ...
                       <?php
                               include '../config/koneksi.php';
                               $sql2 = mysqli_query($test, "SELECT * FROM tb_dokter WHERE stts='1'");
                               while($bc2=mysqli_fetch_array($sql2))
                               {
