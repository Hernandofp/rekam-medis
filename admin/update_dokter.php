<?php
    ...
    $sql4 = mysqli_query($test, "SELECT * FROM tb_dokter WHERE id_dokter='$_GET[id]'");
    $bc4  = mysqli_fetch_array($sql4);

    $sql5 = mysqli_query($test, "SELECT * FROM tb_user WHERE id_dokter='$_GET[id]'");
